...
const LEGACY: Record<string, string> = {
  ...
  continueContract: "package.continueContract",
  continueInvoice: "package.continueInvoice",
  continuePayment: "package.continuePayment",
  continueTripPlanner: "package.continueTripPlanner",
  backToPackage: "package.backToPackage",
  backToCalendar: "package.backToCalendar",
  backToChat: "package.backToChat",
  backToContract: "package.backToContract",
  backToInvoice: "package.backToInvoice",
  backToPayment: "package.backToPayment",
  signContinue: "package.signContinue",
  tripRecap: "package.tripRecap",
  viewMore: "package.viewMore",
  shareCloset: "package.shareCloset",
  bikeRental: "package.bikeRental",
  lockedUntilReservation: "package.lockedUntilReservation",
